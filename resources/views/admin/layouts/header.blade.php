				...
				<div class="collapse navbar-collapse" id="sidenav-collapse-main">
					...
					<ul class="navbar-nav mb-md-3">
						<li class="nav-item ">
							...
							<li class="nav-item ">
								<a class="nav-link" href="{{ route('websiteinfo.index') }}">
									<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="browser" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-browser fa-w-16 fa-2x text-orange mr-2" style="width: 18px;"><path fill="currentColor" d="M464 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h416c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48zM128 148c0 6.6-5.4 12-12 12H76c-6.6 0-12-5.4-12-12v-40c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v40zm320 0c0 6.6-5.4 12-12 12H188c-6.6 0-12-5.4-12-12v-40c0-6.6 5.4-12 12-12h248c6.6 0 12 5.4 12 12v40z" class=""></path></svg>
