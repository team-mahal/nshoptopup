		...
		<div class="card mt-5">
			<div class="card-header border-0">
				<div class="row align-items-center">
					<div class="col">
						<h3 class="mb-0">Notice List</h3>
					</div>
					<div class="col text-right">
						<a href="{{ route('notice.create') }}" class="btn btn-sm btn-primary">Create New</a>
					</div>
				</div>
			</div>
			<?php if(empty($datas)){  ?>
					...
					<tbody>
						...
						<tr>
							...
							<td style="display: -webkit-inline-box;">
								<a href="{{ route('notice.edit',[$data->id]) }}" class="btn btn-success btn-sm">Edit</a>
