		...
		<div class="card mt-5">
			<div class="card-header border-1 bg-gradient-primary">
				<div class="row align-items-center">
					<div class="col">
						<h3 class="mb-0 text-white">notice Edit</h3>
					</div>
			...
			<form action="{{ route('notice.update',[$notice->id]) }}" method="post" enctype="multipart/form-data" class="p-4">
				@csrf
				@method('PUT')
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							<div class="form-group">
								...
								<textarea name="notice" class="form-control">{{ $notice->notice }}</textarea>
							</div>
						</div>
