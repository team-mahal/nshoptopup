							...
							<div class="form-group">
								...
								<div class="flatpickr form__group field" id="endDate" class="form__field">
									<input data-input type="text" name="exam_end_datetime" id="exam_end_datetime"
										autocomplete="off" placeholder="Select Date of modification" class="form-control">
									<!-- input is mandatory -->
								</div>
							</div>
						</div>
			...
			<div class="card-header border-0">
				<div class="row align-items-center">
					...
					<div class="col text-right">
						<a href="{{ url('/admin/brandCreate') }}" class="btn btn-sm btn-primary">Create New</a>
					</div>
				</div>
			</div>
			<?php if(empty($datas)){  ?>
				...
				<table class="table align-items-center table-flush">
					...
					<tbody>
						...
						<tr>
							...
							<td style=""><img src="{{ asset('brand/' . $data->logo) }}" alt="Oops"
