...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ url('/admin/productCreate') }}" class="btn btn-success">Create</a>
	</div>
	<div class="row">
            @csrf
	  ...
	  <tbody>
        @foreach($data as $key => $data)
	    	<tr>
			  ...
			  <td style=""><img src="{{ asset('product/' . $data->logo) }}" alt="Oops" style="max-height: 100px; max-width:100px"> </td>
