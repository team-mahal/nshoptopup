<template>
    <div class="container mx-auto w-full md:w-6/12 xl:w-6/12 p-2 md:p-0 justify-center shadow-lg hover:shadow-xl border-2 p-4 lg:p-8">
        <h1 class="text-2xl md:text-3xl mt-2 font-extrabold">{{ blog.title }}</h1>
        <img
            :src="'/blog/' + blog.logo"
