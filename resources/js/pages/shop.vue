    ...
    <div class="container mx-auto">
        ...
        <div class="text-center">
            ...
            >
                ...
                <p  @click="addToCart(product)" class="flex justify-center items-center text-white cursor-pointer bg-orange-500 hover:bg-red-300 text-white font-normal py-2 px-2 rounded mx-2 mb-4">
